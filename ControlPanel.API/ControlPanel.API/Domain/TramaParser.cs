...
/* CLASE QUE IMPLEMENTA LA INTERFAZ "ITramaParser"
 * Su responsabilidad es interpretar (parsear) las tramas de texto
 * que envían las cabinas y convertirlas en objetos SensorData.
 * 
